    ...
    return (
        ...
        <>  
            <div id="hot"  style={{ margin: "3% 1% 1% 1%", minWidth: "20%",maxWidth:"100%" }}>
                <div  className= "d-flex justify-content-end flex-row bd-highlight align-items-center">
                ...
                <div  className= "d-flex justify-content-center flex-column bd-highlight align-items-center mb-4">
                    <img src={re} alt="" style={{ maxHeight: "80px" }} /> <br />
                    <h5>Jonas Kanwald</h5>

                </div>
                <div  className= "d-flex justify-content-center flex-row bd-highlight align-items-center mb-4" >
                    <button type="button"  className= "btn btn-primary" style={{ background: "rgba(248, 209, 229, 0)", border: " none" }}>
                ...
                <div  className= "d-flex justify-content-between flex-row bd-highlight align-items-center">
