...
const Main = () => {
    return (
        <>
            <div className="d-flex flex-column bd-highlight" style={{ margin: "1%  1% 1% 1% ", padding: "2%", minWidth: "50%" }} id="mas">
                <div className="d-flex justify-content-between flex-row bd-highlight mb-3" >
                    <div className="d-flex justify-content-start flex-row bd-highlight mb-3" style={{minWidth:"70%"}} >
                        <Sidebar/>
                        <div className="red" >
                ...
                <div className="container">
                    <div className="d-flex flex-row justify-content-around wrap" id='wrapper'>
                        <div className="card">
                ...
                <div className="d-flex justify-content-around" id="wrapper">
                    <div className="card2" id="card3" style={{ minWidth: "50%", marginTop: "0" }}>
                        <div className="d-flex justify-content-between">
                    ...
                    <div className="card2" id="card4" style={{ minWidth: "30%", marginTop: "0", marginLeft: "10px", paddingLeft: "10px" }} >
                        <div className="d-flex justify-content-between">
                            <span> <h5>Efficiency</h5></span>
                            <span><h5><img src={grp} alt="" /></h5></span>
                        </div>
                        <div className="d-flex justify-content-center " id="chart3">
                            <PieC />
                        </div>
                    </div>
                </div>
